...
export const register = theme => ({
  ...
  paper: {
    ...
    boxShadow: ".2px 8px 8px rgba(131,153,167,0.6)",

    "&:hover": {
      boxShadow: "0px 14px 26px rgba(131,153,167,0.99)"
    }
  },
  avatar: {
    marginTop: 20,
    ...
    width: "100px",
    height: "100px",
    boxShadow: "0px 0px 10px rgba(131,153,167,0.99)"
  },
